	...
	<div id="contenedorAdministrador">
		...
		<aside>
			<ul id="menuAdmin">
				...
				<li><a href="../estadistica.html">Estadiscas</a></li>
				<li>
		...
		<section id="principal">
			<H2>Agregar Museos</H2>
			<br/>
              <form action="Ctrlagregar.php">
              <table class="tabla" >
              	<h4>Datos generales</h4>
            
                	<tr><th>Nombre</th><td><input type="text" placeholder="Nombre.."></td></tr>
                	<tr><th>Delegacion</th><td><input type="text" placeholder="Delegacion.."></td></tr>
              	<tr>
              		<th>Titulo</th>
              		<th>Cuerpo</th>
              	</tr>
              	<tr>
              		<td>
              			<input type="text" id="titulo" style="width:100%;height:70px;">
              		</td>
